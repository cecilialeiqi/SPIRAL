...
TRAIN = load('50words_TRAIN');%synthetic_control_TRAIN'); % Only these two lines need to be changed to test a different dataset. % 
...
TEST(:,1) = [];
% Pull out the % Remove class % Pull out the % Remove class we got correct class labels.
%labels from training set. class labels.
%labels from testing set.
correct = 0; % Initialize the number
